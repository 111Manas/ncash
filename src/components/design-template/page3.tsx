...
import Image3 from "../../../public/images/bg-3.png";
import ArrowLeft from "../../../public/images/icons/arrow-left-short.svg";
          ...
          <div className="container p-0 m-0">
            <div className="card shadow p-3 bg-grey border-0">
              ...
              <div className="card shadow inputCard p-2 mt-4 mb-4 d-md-none d-lg-none d-xl-none d-xxl-none">
                <p className="cardtitle text-center fw-bold mb-0">
                  Verification OTP
                </p>
                <span className="text-center fw-bold text-black fs-small mt-2 mb-2">
                  We Have Sent The Code Verification To Your <br />
                  Mobile Number
                </span>
                <span className="text-center fw-bold text-black mb-2 fs-5">
                ...
                <p className="fs-small fw-bolder text-secondary text-center mb-0 mt-1">
                  Didn't receive Verification Code?
                </p>
                <span className="d-flex justify-content-center mb-2">
                  <span className="fs-6 fw-bolder text-lightblue text-center mt-1">
                    Resend Code
                  </span>{" "}
                  &nbsp;&nbsp; <span className="text-red mt-1 fs-6">00:25</span>
                </span>
              </div>
